...
BUS_COLUMNS: dict[str, tuple[str, str, str]] = {
    ...
    "Bus Voltage (kV)":                         ("Voltage (kV)", "Nominal voltage class of the bus. 'Medium voltage' for siting is typically ≤115 kV.", "num"),
    ...
    "Constraint Headroom (MW)":                 ("Headroom (MW)", "MW of remaining margin on the first binding constraint. This is the 'headroom' Bill asked for.", "num"),

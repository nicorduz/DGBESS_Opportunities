...
--------------------
Bill / Niko want to ask the data questions in plain English — "what's the best
115 kV node in Massachusetts with the most headroom and the least congestion?",
"which owner has the most open capacity in Rhode Island?", "compare the top 5
buses near Worcester" — and get a real answer that reads the tables and reasons.
...
- 'Voltage (kV)' = bus voltage class. The team's siting sweet spot is MEDIUM voltage,
  i.e. ≤115 kV, and Bill specifically looks at 69 kV and 115 kV (and 27/33/69 kV in NY).
...
3. Always name the bus (Bus Name), its voltage, headroom, capacity, county/state, owner,
   and the limiting constraint when you cite a node.
4. If the question asks about something the data does NOT cover (for example New York /
   Westchester headroom — this export is ISO-NE only), say so plainly instead of guessing.
